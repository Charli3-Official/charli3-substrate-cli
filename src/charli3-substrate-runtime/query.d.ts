...
export interface ChainStorage<Rv extends RpcVersion> extends GenericChainStorage<Rv> {
  ...
  oracle: {
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    minNodesForTrustedAggregation: GenericStorageQuery<Rv, () => number | undefined>;
     ...
     **/
    tradePairs: GenericStorageQuery<Rv, () => Array<PalletOracleConfigNodeTradePair> | undefined>;

    /**
     *
     * @param {Callback<Array<[Bytes, Array<number>]> | undefined> =} callback
     **/
    channelsToTradePairs: GenericStorageQuery<Rv, () => Array<[Bytes, Array<number>]> | undefined>;
    ...
    nodesPrices: GenericStorageQuery<
      Rv,
      (arg: [PalletOracleConfigNodeTradePair, AccountId32Like]) => [number, number] | undefined,
     ...
     **/
    aggregation: GenericStorageQuery<Rv, () => PalletOracleAggregationState | undefined>;
